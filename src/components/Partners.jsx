        ...
        <div className="bg-[#020107]">
            ...
            <FadeInWhenVisible>
                <div className="flex flex-col justify-center items-center text-center gap-3 pt-16 px-4">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-5 py-10">
                        {[Frame2, Frame3, Frame4, Frame5, Frame6].map(
                            (img, i) => (
                                <img
                                    key={i}
                                    src={img}
            ...
            <FadeInWhenVisible>
                <div className="bg-gradient-to-r from-[#111348] via-[#05071E] to-[#111348] px-4 py-16 md:py-20">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-7xl mx-auto rounded-4xl shadow-md bg-gradient-to-r from-[#04040A] via-[#05071E] to-[#111348] lg:px-0 px-10 lg:py-0 py-10  hover:bg-gradient-to-r hover:from-[#111348] hover:via-[#05071E] hover:to-[#04040A] transition  ease-in-out duration-1000">
                        {/* TEXT CONTENT */}
                        <header className="flex flex-col gap-6 text-left flex-1 lg:px-20">
