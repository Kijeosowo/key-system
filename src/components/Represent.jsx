...
const Represent = () => {
    ...
    return (
        <div className="bg-[#05071E] px-4 py-20">
            <FadeInWhenVisible>
                <header className="flex flex-col gap-5 justify-center items-center text-center mb-16">
            ...
            <FadeInWhenVisible>
                <main className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
