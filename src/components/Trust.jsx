...
const Trust = () => {
    ...
    return (
        <div className="bg-[#020107] px-4 lg:px-20 lg:pt-10 lg:pb-32">
            {/* TRUST SECTION */}
            <FadeInWhenVisible>
                <header className="flex flex-col justify-center items-center pb-20 pt-20 gap-5 text-center">
            ...
            {/* PROCESS SECTION */}
            <FadeInWhenVisible>
                <header className="flex flex-col justify-center items-center text-center gap-3 mb-10">
                    <h1 className="text-[32px] md:text-[50px] font-semibold text-white">
